				...
				<div style="margin:12px;">
					<el-card>
						<div style="text-align: center">
							<el-avatar
								:size="120"
								:src="require('../assets/icons/3.jpg')"
							></el-avatar>
						</div>
						<div style="text-align: center; margin: 24px 0;">
							<el-tag effect="plain" style="padding: 0 30px;font-size: 18px;"
								>个人信息</el-tag
							>
						</div>
						<div style="margin-left: 12px;">
							<div style="margin-bottom: 16px;">
								<span style="color: #8c939d;"
									>婚姻状况：{{ livelyForm.status }}</span
								>
							</div>
							<div style="margin-bottom: 16px;">
								<span style="color: #8c939d;"
									>是否有小孩：{{ livelyForm.children }}</span
								>
							</div>
							<div style="margin-bottom: 16px;">
								<span style="color: #8c939d;"
									>住房情况：{{ livelyForm.house }}</span
								>
							</div>
							<div style="margin-bottom: 16px;">
								<span style="color: #8c939d;"
									>买车情况：{{ livelyForm.car }}</span
								>
							</div>
							<div style="margin-bottom: 16px;">
								<span style="color: #8c939d;"
									>是否吸烟: {{ livelyForm.smoke }}</span
								>
							</div>
							<div style="margin-bottom: 16px;">
								<span style="color: #8c939d;"
									>是否喝酒：{{ livelyForm.drink }}</span
								>
							</div>
							<div style="margin-bottom: 16px;">
								<span style="color: #8c939d;"
									>健康状况：{{ livelyForm.health }}</span
								>
							</div>
							<div style="margin-bottom: 16px;">
								<span style="color: #8c939d;"
									>宗教信仰：{{ livelyForm.religion }}</span
								>
							</div>
						</div>
					</el-card>
					...
					<el-card :body-style="{ padding: '8px' }">
						<div style="text-align: center; margin: 0 6px;">
							<el-carousel height="260px" indicator-position="outside">
								<el-carousel-item>
									<el-image
										:src="require('../assets/icons/girl1.jpg')"
									></el-image>
								</el-carousel-item>
								<el-carousel-item>
									<el-image
										:src="require('../assets/icons/girl2.jpg')"
									></el-image>
								</el-carousel-item>
								<el-carousel-item>
									<el-image
										:src="require('../assets/icons/girl4.jpg')"
									></el-image>
								</el-carousel-item>
								<el-carousel-item>
									<el-image
										:src="require('../assets/icons/girl5.jpg')"
									></el-image>
								</el-carousel-item>
								<el-carousel-item>
									<el-image
										:src="require('../assets/icons/girl6.jpg')"
									></el-image>
								</el-carousel-item>
							</el-carousel>
						</div>
						<div align="center" style="margin-top: 12px;">
							<el-button icon="el-icon-chat-square" type="primary"
								>发消息</el-button
							>
							<el-button icon="el-icon-star-off" type="primary">关注</el-button>
							<el-button icon="el-icon-collection" type="primary"
								>联系方式</el-button
							>
						...
						<el-row>
							<el-col :span="12">
								<div style="margin-left: 24px;">
									<div style="margin-bottom: 16px;">
										<span style="color: #8c939d;"
											>用户昵称：{{ personalForm.username }}</span
										>
									</div>
									<div style="margin-bottom: 16px;">
							...
							<el-col :span="12">
								<div style="margin-left: 12px;">
									<div style="margin-bottom: 16px;">
										<span style="color: #8c939d;"
											>我的学历：{{ personalForm.degree }}</span
										>
									</div>
									<div style="margin-bottom: 16px;">
										<span style="color: #8c939d;"
											>我的身高：{{ personalForm.height }}</span
										>
									</div>
									<div style="margin-bottom: 16px;">
