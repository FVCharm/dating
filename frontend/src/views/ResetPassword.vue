	...
	<div class="passwordForm">
		<el-card shadow="hover" style="width: 720px;">
			...
			<el-form
				...
				:rules="rules"
			>
				<el-form-item label="手机号" style="margin:24px 140px; " prop="phone">
				...
				<el-form-item
					label="验证码"
					prop="verCode"
					style="width:380px;margin:20px 140px;"
				>
			...
			<el-form label-width="100px" v-else>
				...
				></el-alert>
				<div align="center">
					<el-button type="success" @click="nextStep3" style="margin-top: 12px;"
						>完成</el-button
					>
				</div>
			</el-form>
