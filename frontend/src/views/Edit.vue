											...
											<div class="clearfix" slot="header">
												...
												>
													...
													<span class="dialog-footer" slot="footer">
														<el-button @click="modifyDialog = false"
															>稍后认证</el-button
														>
														<el-button
									...
									<el-row style="margin-top: 20px">
										<el-card>
											...
											<div style="padding-right:48px; margin-top:18px">
												...
												<div style="text-align:center">
													<el-button @click="saveContactForm" type="primary"
														>保存资料</el-button
													>
												</div>
											</div>
									...
									<el-card style="text-align:center">
										...
										<el-row>
											...
											>
												<h4>实名认证</h4>
												<span
													>可以使用更多网站的定制功能，推荐更多诚信的优质客户，与心仪的人发送消息，同时点亮左侧认证图标</span
												>
											</el-col>
							...
							<el-row>
								<el-col :offset="1" :span="22">
									<el-card>
										...
										<h4>谁可以看我的资料</h4>
										<div>
											<el-radio border label="1" v-model="radio"
												>所有人</el-radio
											>
											<el-radio border label="2" v-model="radio"
												>只有认证用户</el-radio
											>
											<el-radio border label="3" v-model="radio"
												>符合择偶条件的认证用户</el-radio
											>
										</div>
										<el-divider></el-divider>
										<h4>谁可以查看我的联系方式</h4>
										<div>
											<el-radio border label="1" v-model="radio1"
												>所有人</el-radio
											>
											<el-radio border label="2" v-model="radio1"
												>只有认证用户</el-radio
											>
											<el-radio border label="3" v-model="radio1"
												>符合择偶条件的认证用户</el-radio
											>
										</div>
										<el-divider></el-divider>
										<h4>我的恋爱状态</h4>
										<div>
											<el-radio border label="1" v-model="radio2"
												>寻觅中</el-radio
											>
											<el-radio border label="2" v-model="radio2"
												>约会中</el-radio
											>
											<el-radio border label="3" v-model="radio2"
												>热恋中</el-radio
											>
											<el-radio border label="4" v-model="radio2"
												>我结婚啦</el-radio
											>
										</div>
									</el-card>
										...
										<el-row justify="center" type="flex">
											...
											>
												<el-form-item label="手机号" style="margin-top: 20px;">
													{{
														passwordForm.phone.substring(0, 3) +
															'****' +
															passwordForm.phone.substring(
																passwordForm.phone.length - 4,
																passwordForm.phone.length
															)
													}}
													<el-button
														v-model.number="passwordForm.phone"
														@click="sendCode(passwordForm)"
												...
												<el-form-item label="验证码" prop="verCode">
													<el-input
														v-model.number="passwordForm.verCode"
													></el-input>
												</el-form-item>
												<div align="center">
													<el-button
														@click="nextStep1('passwordForm')"
	...
	data() {
		...
		return {
			...
			rules: {
				...
				newPassword2: [{ validator: checkPass2, trigger: 'blur' }],
